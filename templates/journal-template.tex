...
% Ensure index starts on a right (odd) page
% Clear to next odd page, making blank pages empty (no footer)
\clearpage
\ifodd\value{page}
  % Already on odd - do nothing
\else
  % On even - add blank odd page without footer
  \thispagestyle{empty}
  \mbox{}
  \clearpage
\fi
