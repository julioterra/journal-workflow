...
\definecolor{tag-bg-default}{RGB}{255,245,157}     % Light yellow highlight (default)
...
% Define colors for zebra striping (very subtle)
\definecolor{tablerowlight}{RGB}{255,255,255}  % White
\definecolor{tablerowdark}{RGB}{248,248,248}   % Very light gray
...
% Volume - medium bold
$if(volume)$
{\large\itshape\bfseries \volume\par}
\vspace{-0.4em}
$endif$

% Date Range - large bold
$if(dates)$
{\large\itshape \dates\par}
\vspace{4em}
$endif$
