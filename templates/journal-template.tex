...
% Index formatting
\setlength{\columnsep}{2cm}  % Space between columns (adjust to taste)

% Reduce inconsistent vertical spacing between letter groups
\makeatletter
\renewcommand{\indexspace}{\vspace{0.5\baselineskip}}  % Consistent small gap
\makeatother
